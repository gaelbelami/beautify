...
export const primitiveColors = {
  // Neutral colors (optimized - removed redundant similar colors)
  slate: {
    50: '#f8fafc',
    100: '#f1f5f9',
    200: '#e2e8f0',
...
export const createTheme = (
  ...
  const neutral = primitiveColors.neutral;
  ...
  const chartColors: ChartColors = {
    chart1: primary[500],
    chart2: primitiveColors.emerald[500],
    chart3: primitiveColors.amber[500],
    chart4: primitiveColors.violet[500],
    chart5: primitiveColors.cyan[500]
  };
...
export const defaultThemes: Record<string, ThemeConfig> = {
  // Neutral themes (optimized - removed redundant similar colors)
  slate: createTheme('slate', 'Slate', 'slate'),
  neutral: createTheme('neutral', 'Neutral', 'neutral'),
  stone: createTheme('stone', 'Stone', 'stone'),
  
  // Warm colors
  red: createTheme('red', 'Red', 'red'),
  orange: createTheme('orange', 'Orange', 'orange'),
  amber: createTheme('amber', 'Amber', 'amber'),
  yellow: createTheme('yellow', 'Yellow', 'yellow'),
  
  // Green spectrum
  lime: createTheme('lime', 'Lime', 'lime'),
  green: createTheme('green', 'Green', 'green'),
  emerald: createTheme('emerald', 'Emerald', 'emerald'),
  teal: createTheme('teal', 'Teal', 'teal'),
  
  // Blue spectrum
  cyan: createTheme('cyan', 'Cyan', 'cyan'),
  sky: createTheme('sky', 'Sky', 'sky'),
  blue: createTheme('blue', 'Blue', 'blue'),
  indigo: createTheme('indigo', 'Indigo', 'indigo'),
  
  // Purple spectrum
  violet: createTheme('violet', 'Violet', 'violet'),
  purple: createTheme('purple', 'Purple', 'purple'),
  fuchsia: createTheme('fuchsia', 'Fuchsia', 'fuchsia'),
  
  // Pink spectrum
  pink: createTheme('pink', 'Pink', 'pink'),
  rose: createTheme('rose', 'Rose', 'rose')
};
